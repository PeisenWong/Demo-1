...
Core/Src/PSx_Interface/%.o: ../Core/Src/PSx_Interface/%.c Core/Src/PSx_Interface/subdir.mk
...
clean-Core-2f-Src-2f-PSx_Interface:
	-$(RM) ./Core/Src/PSx_Interface/PSx_Interface.d ./Core/Src/PSx_Interface/PSx_Interface.o
