...
C_DEPS += \
./Core/Src/obstacle_detect/obstacle_detect.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/obstacle_detect/%.o: ../Core/Src/obstacle_detect/%.c Core/Src/obstacle_detect/subdir.mk
...
clean: clean-Core-2f-Src-2f-obstacle_detect

clean-Core-2f-Src-2f-obstacle_detect:
	-$(RM) ./Core/Src/obstacle_detect/obstacle_detect.d ./Core/Src/obstacle_detect/obstacle_detect.o

.PHONY: clean-Core-2f-Src-2f-obstacle_detect
