...
#ifndef VESC_CAN_DATATYPES_H_
#define VESC_CAN_DATATYPES_H_
...
typedef struct {
	float v_in;
	float temp_mos;			//filtered mosfet temperature
	float temp_motor;		//filtered motor temperature
	float current_motor;
	float current_in;
	float id;
	float iq;
...
typedef enum {
	...
	CAN_PACKET_STATUS_8,
	CAN_PACKET_STATUS_9,
	CAN_PACKET_STATUS_10,
	CAN_PACKET_SET_CURRENT_1,
	CAN_PACKET_SET_CURRENT_2,
	CAN_PACKET_SET_CURRENT_3,
	CAN_PACKET_SET_TACHOMETER,
	CAN_PACKET_BRAKE,
	CAN_PACKET_RELEASE_MOTOR,
	CAN_PACKET_GET_INFO,
